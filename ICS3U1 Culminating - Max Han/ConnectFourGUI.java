...
public class ConnectFourGUI {
   ...
   */
   public void showTieGameMessage(){
      String[] options = {"Restart Game", "Exit"};
      int selection = JOptionPane.showOptionDialog(null, "This game is tie.", "Tie Game", 
   ...
   */
   public void showWinnerMessage(int player){
      String[] options = {"Restart Game", "Exit"};
      int selection = JOptionPane.showOptionDialog(null, " won this game!", "This game has a winner!", 
